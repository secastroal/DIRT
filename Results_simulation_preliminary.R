...
grm_files <- paste0(getwd(), "/Simulation/Sim_AR_GRM_cond_", 1:20, ".txt")
grmf_files <- paste0(getwd(), "/Simulation/Sim_AR_GRM_fix_cond_", 1:20, ".txt")
pcm_files <- paste0(getwd(), "/Simulation/Sim_AR_PCM_cond_", 1:20, ".txt")
sgrm_files <- paste0(getwd(), "/Simulation/Sim_S_GRM_cond_", 1:20, ".txt")
spcm_files <- paste0(getwd(), "/Simulation/Sim_S_PCM_cond_", 1:20, ".txt")
