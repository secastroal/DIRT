...
```{r}
files <- paste0("../Simulation/Sim_TV_DPCM_", model_version, "_cond_", 1:nrow(Cond), ".txt")
...
barplot(counts[, c(1, 3, 2, 4)], space = c(0, 0.2, 1, 0.2),
        ...
        names.arg = c(0.25, 0.5, 0.25, 0.5), col = color_plot,
        ylab = "Number of Replications",
        args.legend = list(x = "right", xpd = NA, inset = -0.3))
