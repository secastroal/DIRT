...
library(bookdown)
library(kableExtra)
knitr::opts_chunk$set(echo = FALSE, fig.height = 4, fig.width = 6, fig.pos = "!p",  
                      warning=FALSE, message=FALSE)

#rmarkdown::render("Rmarkdown/PGdata_analysis_SE_complete.Rmd")
```
...
rdsfile <- "../Fits/SelfEwithNA_3items"
...
```{r rhats-se-comp, fig.cap = "Gelman-Rubin Statistics for the Estimated Parameters of the TV-DPCM"}
mcmc_rhat(rhat(fit, pars = c("beta", "theta", "lambda", 
                             "sigma2", "pvar", "attractor")))
```

```{r trace-se-comp, fig.cap = "Traceplots of Selected Parameters"}
...
```{r acf-plots-se-comp, fig.cap = "Autocorrelation Plots of Selected Parameters"}
mcmc_acf(fit.array, 
...
```{r IIF-se-comp, fig.cap = "Item Information Functions of the Items of Self-Esteem"}
...
```{r expected-plot-comp, fig.cap = "Comparison Between the Estimated Latent States Dispositions, the Expected Mean Scores, and the Observed Mean Scores."}
...
```{r obs-exp-comp, fig.cap = "Observed vs. Expected Mean Scores for the Last 50 Observations"}
