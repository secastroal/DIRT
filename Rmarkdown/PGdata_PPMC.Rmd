...
```{r q1, fig.height = 6, results = 'hide', fig.cap = "Yen's Q1 of the items of MU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
...
```{r q1-alt, fig.height = 6, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of MU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
...
```{r}
stan.diag <- monitor(extract(fit, pars = c("beta", "theta", "lambda", 
                                        "sigma2", "pvar", "attractor"),
                             permuted = FALSE, inc_warmup = FALSE), 
                                 warmup = 0, print = FALSE)
...
```{r, fig.height = 6, fig.cap = "Observed vs. Simulated Item Scores", results = 'hide'}
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.item.ts(object = fit, data = standata, quiet = TRUE)
```
...
```{r, results = 'hide', fig.height = 6, fig.cap = "Item-Total Correlation"}
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.itcor(object = fit, data = standata, quiet = TRUE, method = "pearson")
```
...
```{r, results = 'hide', fig.height = 6, fig.cap = "Item-Total Correlation with AR(1) Residuals for the Total"}
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.itcor2(object = fit, data = standata, quiet = TRUE, method = "pearson")
```
...
```{r, results = 'hide', fig.height = 6, fig.cap = "Item-Total Correlation with AR(1) Residuals for Item and Total Scores"}
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.itcor3(object = fit, data = standata, quiet = TRUE)
```
...
```{r, fig.height = 6, results = 'hide', fig.cap = "Yen's Q1 of the items of NegA"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 6, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of NegA"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, results = 'hide', fig.cap = "1st Partial Autocorrelation of the Item Scores", fig.height = 6}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(3, 4, 2, 2) + 0.1)
ppmc.lpacf(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 6, results = 'hide', fig.cap = "Yen's Q1 of the items of PosA"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 6, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of PosA"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 6, results = 'hide', fig.cap = "Yen's Q1 of the items of NAMU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 6, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of NAMU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 6, results = 'hide', fig.cap = "Yen's Q1 of the items of MU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 6, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of MU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
