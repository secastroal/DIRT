...
```{r item-ts, fig.height = 8, fig.cap = "Observed vs. Simulated Item Scores"}
...
## TV-DPCM of Negative Affect (NegA, 5 categories)

Here, we fitted the TV-DPCM to the 4 items of negative affect. Response categories 1 and 2; and 6 and 7 were merged into two response categories.
...
```{r, fig.cap = "Sumscores of Negative Affect"}
index <- which(!is.na(responses[, 1]))[seq(1, sum(!is.na(responses[, 1])), 20)]
plot(index, rowMeans(responses)[index], yaxt = 'n', las = 1, type = "l", 
     ylab = "Meanscores NegA", xlab = "Beep")
```
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Yen's Q1 of the items of NegA"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of NegA"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, results = 'hide', fig.cap = "Yen's Q3 for the items of NegA"}
time0 <- proc.time()
ppmc.Q3(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Odds Ratio for the items of NegA"}
time0 <- proc.time()
ppmc.OR(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Absolute Item Covariance Residual of the items of NegA"}
time0 <- proc.time()
ppmc.cov.resid(object = fit, data = standata)$ppp
proc.time() - time0
```
...
## TV-DPCM of Positive Affect (PosA, 5 categories)

Here, we fitted the TV-DPCM to the 5 items of positive affect. Response categories 1 and 2; and 6 and 7 were merged into two response categories.
...
```{r, fig.cap = "Sumscores of Positive Affect"}
index <- which(!is.na(responses[, 1]))[seq(1, sum(!is.na(responses[, 1])), 20)]
plot(index, rowMeans(responses)[index], yaxt = 'n', las = 1, type = "l", 
     ylab = "Meanscores PosA", xlab = "Beep")
```
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Yen's Q1 of the items of PosA"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of PosA"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, results = 'hide', fig.cap = "Absolute Item Covariance Residual of the items of PosA"}
time0 <- proc.time()
ppmc.cov.resid(object = fit, data = standata)$ppp
proc.time() - time0
```
...
## TV-DPCM of Negative Affect and Mental Unrest (NAMU, 5 categories)

Here, we fitted the TV-DPCM to a combined scale of negative affect with mental unrest. Response categories 1 and 2; and 6 and 7 of the items of negative affect were merged into two response categories. Response categories 5 to 7 of the items of mental unrest were merged into one.
...
```{r, fig.cap = "Sumscores of Combined Scale"}
index <- which(!is.na(responses[, 1]))[seq(1, sum(!is.na(responses[, 1])), 20)]
plot(index, rowMeans(responses)[index], yaxt = 'n', las = 1, type = "l", 
     ylab = "Meanscores NAMU", xlab = "Beep")
```
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Yen's Q1 of the items of NAMU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of NAMU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, results = 'hide', fig.cap = "Yen's Q3 for the items of NAMU"}
time0 <- proc.time()
ppmc.Q3(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Odds Ratio for the items of NAMU"}
time0 <- proc.time()
ppmc.OR(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Absolute Item Covariance Residual of the items of NAMU"}
time0 <- proc.time()
ppmc.cov.resid(object = fit, data = standata)$ppp
proc.time() - time0
```
...
## TV-DPCM of Negative Affect (NegA, 3 categories)

Here, we fitted the TV-DPCM to the 4 items of negative affect. Response categories 1 to 3; and 5 to 7 were merged into two response categories.
...
```{r, fig.cap = "Sumscores of Negative Affect", eval = FALSE}
index <- which(!is.na(responses[, 1]))[seq(1, sum(!is.na(responses[, 1])), 20)]
plot(index, rowMeans(responses)[index], yaxt = 'n', las = 1, type = "l", 
     ylab = "Meanscores NegA", xlab = "Beep")
```
...
```{r, fig.cap = "Observed vs. Simulated Sumscores", results = 'hide', eval = FALSE}
ppmc.sumscore.ts(object = fit, data = standata)
```
...
```{r, results = 'hide', fig.cap = "1st, 2nd, and 3rd autocorrelation of the sumscores", eval = FALSE}
par(mfrow = c(3, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.acf(object = fit, data = standata, lag.max = 3)
```
...
```{r, results = 'hide', fig.cap = "1st Partial Autocorrelation of the Sumscores", eval = FALSE}
ppmc.racf(object = fit, data = standata)
```
...
```{r, results = 'hide', fig.cap = "Mean Squared Succesive Differences of the Sumscores", eval = FALSE}
ppmc.mssd(object = fit, data = standata)
```
...
```{r, fig.height = 8, fig.cap = "Observed vs. Simulated Item Scores", eval = FALSE}
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.item.ts(object = fit, data = standata, quiet = TRUE)
```
...
```{r, results = 'hide', fig.height = 8, fig.cap = "Item-Total Correlation", eval = FALSE}
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.itcor(object = fit, data = standata, quiet = TRUE, method = "pearson")
```
...
```{r, results = 'hide', fig.height = 8, fig.cap = "Item-Total Correlation with AR(1) Residuals for the Total", eval = FALSE}
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.itcor2(object = fit, data = standata, quiet = TRUE, method = "pearson")
```
...
```{r, results = 'hide', fig.height = 8, fig.cap = "Item-Total Correlation with AR(1) Residuals for Item and Total Scores", eval = FALSE}
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.itcor3(object = fit, data = standata, quiet = TRUE)
```
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Yen's Q1 of the items of NegA", eval = FALSE}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of NegA", eval = FALSE}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, results = 'hide', fig.cap = "1st Partial Autocorrelation of the Item Scores", fig.height = 8, eval = FALSE}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(3, 4, 2, 2) + 0.1)
ppmc.lpacf(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, results = 'hide', fig.cap = "Yen's Q3 for the items of NegA", eval = FALSE}
time0 <- proc.time()
ppmc.Q3(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Odds Ratio for the items of NegA", eval = FALSE}
time0 <- proc.time()
ppmc.OR(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Odds Ratio Difference between Two Halves of the Observations", eval = FALSE}
time0 <- proc.time()
ppmc.ORDiff(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Absolute Item Covariance Residual of the items of NegA", eval = FALSE}
time0 <- proc.time()
ppmc.cov.resid(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Absolute Item Covariance Residual Difference between Two Halves of the Observations", eval = FALSE}
time0 <- proc.time()
ppmc.cov.rediff(object = fit, data = standata)$ppp
proc.time() - time0
```
...
## TV-DPCM of Positive Affect (PosA, 3 categories)

Here, we fitted the TV-DPCM to the 5 items of positive affect. Response categories 1 to 3; and 5 to 7 were merged into two response categories.
...
```{r, fig.cap = "Sumscores of Positive Affect", eval = FALSE}
index <- which(!is.na(responses[, 1]))[seq(1, sum(!is.na(responses[, 1])), 20)]
plot(index, rowMeans(responses)[index], yaxt = 'n', las = 1, type = "l", 
     ylab = "Meanscores PosA", xlab = "Beep")
```
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Yen's Q1 of the items of PosA", eval = FALSE}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of PosA", eval = FALSE}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, results = 'hide', fig.cap = "Yen's Q3 for the items of PosA", eval = FALSE}
time0 <- proc.time()
ppmc.Q3(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Odds Ratio for the items of PosA", eval = FALSE}
time0 <- proc.time()
ppmc.OR(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Absolute Item Covariance Residual of the items of PosA", eval = FALSE}
time0 <- proc.time()
ppmc.cov.resid(object = fit, data = standata)$ppp
proc.time() - time0
```
...
## PCM of Mental Unrest (MU, 5 categories)

Here, we fitted the PCM to the 3 items of mental unrest. Response categories 5 to 7 were merged into one.
...
```{r, fig.cap = "Sumscores of Mental Unrest"}
index <- which(!is.na(responses[, 1]))[seq(1, sum(!is.na(responses[, 1])), 20)]
plot(index, rowMeans(responses)[index], yaxt = 'n', las = 1, type = "l", 
     ylab = "Meanscores MU", xlab = "Beep")
```
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Yen's Q1 of the items of MU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, fig.height = 8, results = 'hide', fig.cap = "Modified Yen's Q1 of the items of MU"}
time0 <- proc.time()
par(mfrow = c(I, 1), mar = c(2, 3, 2, 2) + 0.1)
ppmc.Q1.alt(object = fit, data = standata, quiet = TRUE)
proc.time() - time0
...
```{r, results = 'hide', fig.cap = "Yen's Q3 for the items of MU"}
time0 <- proc.time()
ppmc.Q3(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Odds Ratio for the items of MU"}
time0 <- proc.time()
ppmc.OR(object = fit, data = standata)$ppp
proc.time() - time0
```
...
```{r, results = 'hide', fig.cap = "Absolute Item Covariance Residual of the items of MU"}
time0 <- proc.time()
ppmc.cov.resid(object = fit, data = standata)$ppp
proc.time() - time0
```
...
## PCM of Negative Affect (NegA, 5 categories)

Here, we fitted the PCM to the 4 items of negative affect. Response categories 1 and 2; and 6 and 7 were merged into two response categories.
...
## PCM of Positive Affect (PosA, 5 categories)

Here, we fitted the PCM to the 5 items of positive affect. Response categories 1 and 2; and 6 and 7 were merged into two response categories.
