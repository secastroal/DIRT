...
setmodel <- "TVPCM"
# rmarkdown::render("Rmarkdown/PPMC_Tests.Rmd", output_file = paste0("Rmarkdown/PPMC_Tests_", setmodel, "_", seed))
```
...
```{r acftable, results="hide", fig.show = "hide"}
...
```{r itcor, resutls = "hide", fig.show='hide'}
...
```{r itcor2, resutls = "hide", fig.show='hide'}
...
```{r itcor3, resutls = "hide", fig.show='hide'}
...
```{r q1table, resutls = "hide", fig.show='hide'}
...
```{r q1alttable, resutls = "hide", fig.show='hide'}
